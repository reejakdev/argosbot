...
export default function Features() {
  ...
  return (
    <section id="features" className="py-24 border-t border-[rgba(0,212,255,0.08)]">
          ...
          {features.map((feature, i) => {
            ...
            return (
              <motion.div
                ...
                className="hud-card rounded-sm p-5 group"
              >
                <div
                  className="w-9 h-9 rounded-sm flex items-center justify-center mb-4 transition-all duration-300 group-hover:scale-110"
                  style={{
